...
# Obs: o upsert usa constraint (data_referencia, icao_empresa, numero_voo,
# icao_origem, icao_destino, etapa) — o PostgreSQL não aceita que o mesmo
# ON CONFLICT DO UPDATE afete a mesma linha duas vezes na mesma operação.
